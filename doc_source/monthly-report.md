...
**Important**  
The Monthly Report feature will be unavailable at a later date\. We strongly recommend that you use the AWS Cost and Usage Reports instead\.
...
If you use the consolidated billing feature in AWS Organizations, this report is available only for a master \(payer\) account, and includes activity for all the member accounts\. Member account owners can obtain the monthly report only from the master account\. For more information, see [Consolidated Billing for Organizations](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing.html) in the *AWS Billing and Cost Management User Guide*\.
